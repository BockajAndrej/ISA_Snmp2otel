...
#ifndef SNMP2OTEL_SNMPBER_H
#define SNMP2OTEL_SNMPBER_H
...
namespace snmpber {
    ...
    private:
        ...
        std::vector<std::string> TrimString(const std::string& vstup, char delimiter);
        std::vector<uint8_t> IntegerToBytesBigEndian(uint32_t number);
